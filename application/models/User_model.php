...
class user_model extends CI_Model 
{
   ...
   //new add function 
	...
	function add_like($from_user_id, $to_user_id) {
		$firstcheck=array('from_user_id'=>$from_user_id, 'to_user_id'=>$to_user_id);
		$newLike=array('from_user_id'=>$from_user_id, 'to_user_id'=>$to_user_id,'status'=>'Like');
	...
	function add_unlike($from_user_id, $to_user_id) {
		...
		$newLike=array('from_user_id'=>$from_user_id, 'to_user_id'=>$to_user_id,'status'=>'Unlike');
		$this->db->insert('matchs_like',$newLike);
		if($this->db->insert_id()>0)
		   	return true;
		return false;
	}
	//Get encounter pagination of fillert data
	function get_last_registered_users_like_page_with_param($limit, $page, $age_from, $age_to, $gender, $country, $city, $sort_by = "register_date", $user_id = 0)
	{
		$array_params = array();
		...
		//echo '<pre/>',print_r($users->result_array()); die();						   
		return $users;
	}
