	...
	<nav class="navbar navbar-default" role="navigation">
		...
		<div id="sidr">
			<ul>
	            ...
	            ?>
                <li>
	                <a href="<?php echo base_url() ?>chatroom/"><?php echo $this->lang->line("m_chatroom"); ?></a>
	            </li>
		...
		<div id="bs-collapse-1">
			<ul class="nav navbar-nav navbar-left">
	            ...
	            <li>
	                <a href="<?php echo base_url('AddEncounters'); ?>"><span class="nav-label">Encounters</span><?php if(($nb_new_friends+$nb_new_requests) >0): ?><span class="label label-danger pull-right"><?php echo $nb_new_friends+$nb_new_requests; ?></span><?php endif; ?></a>
	            </li>
	            <li>
	                <a href="<?php echo base_url('matches'); ?>"><span class="nav-label"><?php echo $this->lang->line("match"); ?></span><?php if(($nb_new_friends+$nb_new_requests) >0): ?><span class="label label-danger pull-right"><?php echo $nb_new_friends+$nb_new_requests; ?></span><?php endif; ?></a>
	            </li>
	            <?php
				if($settings["enable_payments"] == 1 ):
				?>
	            ...
	            ?>
						        <li>
	                <a href="<?php echo base_url() ?>chatroom"><span class="nav-label"><?php echo $this->lang->line("m_chatroom"); ?></span></a>
	            </li>
	        </ul>
