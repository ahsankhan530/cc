            	...
            	<p>
	                ...
	                <form action="" method="POST" enctype="multipart/form-data" class="form_avatar">
						<div class="form-group" style="text-align:left;">
							...
							<textarea class="form-control form-pm-text" id="pm_main_txt" placeholder="<?php echo $this->lang->line("your_message_pm_modal_placeholder"); ?>" data-emojiable="true"></textarea>
							</p>					
					</div>
